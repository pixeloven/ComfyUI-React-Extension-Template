...
async function initializeExtension(): Promise<void> {
  try {
    ...
    // For standalone development, render directly to the body
    ...
    // Register the sidebar tab using ComfyUI's extension API (if in ComfyUI)
    ...
    // Register extension with about page badges (if in ComfyUI)
